...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'cherry2016@x842f.onmicrosoft.com',
  ...
  email: 'mailto:brett@yukicup.org',
